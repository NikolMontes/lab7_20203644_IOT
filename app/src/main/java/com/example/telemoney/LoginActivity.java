...
//        });
    ...
    private void handleFacebookAccessToken(AccessToken token) {
        ...
        auth.signInWithCredential(credential)
                .addOnSuccessListener(authResult -> goToHome())
                .addOnFailureListener(e -> Toast.makeText(this, "Error con Facebook", Toast.LENGTH_SHORT).show());
    }
...
//                auth.signInWithCredential(credential)
//                        .addOnSuccessListener(authResult -> goToHome())
//                        .addOnFailureListener(e -> Toast.makeText(this, "Error con Google", Toast.LENGTH_SHORT).show());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RC_GOOGLE_SIGN_IN) {
            ...
            try {
                ...
                if (token == null) {
                    Log.e("LoginActivity", "X idToken es null, no se puede autenticar con Firebase");
                } else {
